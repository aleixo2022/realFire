import pandas as pd 
import numpy as np
from db_operationsMI import check_produto_exists, save_produto

contador = 0
def consulta(con):
     
    cur = con.cursor()    
    cur.execute("""select PRODUTO,
    ...
    EMPILHAMENTO_MAXIMO, MOVIMENTA_EST_VOLUME, VERSAO_VOLUME, CNAE_SERV, CODTRIBMUN from produtos""")
